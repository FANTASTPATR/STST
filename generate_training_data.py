...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="data/PEMS-D3", help="Output directory.")
    # parser.add_argument("--traffic_df_filename", type=str, default="data/metr-la.h5", help="Raw traffic readings.", )
    parser.add_argument("--traffic_df_filename", type=str, default="data/PEMS03.npz", help="Raw traffic readings.", )
